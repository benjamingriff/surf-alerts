...
Example SQL queries against the [Forecast Schema](forecast-schema.md). These target the forecast historical layer stored under `processed/forecast/history/` and work with DuckDB, Athena, or any SQL engine reading the Parquet files.
